...
//           <div className="text-center productimgback">
//             <Carousel
//               interval={carouselIndex[props.product.id] ? 3000 : null}
//               controls={false}
    ...
    <div className="d-flex justify-content-center">
      <div className="card productcard product-card">
        ...
        {userDetails.length > 0 && (
            <p className="card-text fw-bold " style={{lineHeight:"20px" , marginTop:"-5px", fontSize:"14px" , color:"rgb(86, 101, 115 )"}}>
              {userDetails[0].shopname}
            </p>
          )}
          {/* <p style={{fontSize:'13px' , marginTop:"-6px"}}>{props.product.name}</p> */}
          <p style={{fontSize:'13px' , marginTop:"-10px" , color:'rgb(93, 109, 126 )'}}> {truncatedName}</p>

          <p className="card-text" style={{lineHeight:"15px" , marginTop:"-8px"}}>
            <b>&#36; {props.product.price}.00</b>
          </p>
          {/* {props.product.size !== "NA" && (
            <h6 className="card-text" style={{ lineHeight: "8px" }}>

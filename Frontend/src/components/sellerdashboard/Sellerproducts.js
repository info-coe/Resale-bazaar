        ...
        <div className="container ">
          <div className="fullscreen2">
            <main>
              ...
              <h6> <i><span className="" style={{color:"blue" , fontSize:"25px"}}>{user.shopname && user.shopname.length>0 ? (user.shopname) : (user.firstname +" "+ user.lastname)}</span></i> Warehouse</h6>
              </div>

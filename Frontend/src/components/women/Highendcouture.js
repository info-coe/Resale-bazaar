  ...
  const fetchProducts = async (pageNum) => {
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_HOST}${process.env.REACT_APP_PORT}/women?limit=${pageSize}&page=${pageNum}&category=High End Couture`
      );
      ...
      <main>
        ...
        <div className="d-lg-flex justify-content-around p-2 ps-lg-5 pe-lg-5">
          ...
          <div className="col-xs-12 col-md-12 col-lg-10 ps-lg-3">
            <Filterdisplaynav pageSize={pageSize} setPageSize={() => {}} productName="High End Couture"/>
...
//         <div className="col-xs-12 col-md-12 col-lg-10 ps-lg-3">
//           <Filterdisplaynav pageSize={pageSize} setPageSize={setPageSize} productName="High End Couture"/>
